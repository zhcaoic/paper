...
# fit network
history = model.fit(train_in, train_out, epochs = 1000, batch_size = 20, validation_data = (valid_in, valid_out), verbose = 1, shuffle = False)
...
# save model
model.save("D:/python_workspace/final_paper/pre_test/model/lstm_model_multi_step_" 
           + str(timesteps) + "_1_1" + ".h5")
